...
import { FaUser, FaEnvelope, FaCamera, FaCheck, FaTimes } from 'react-icons/fa';
import { updateUserProfile } from '../../api/api'; // Update path as needed
  ...
  return (
    <form onSubmit={handleSubmit} className="p-8">
      <div className="relative w-32 h-32 mx-auto mb-6">
        <img
          src={formData.profilePicture || 'https://via.placeholder.com/128'}
